{{-- enable this if no have jquery--}}
{{--<script src="{{ asset('helpers/libs/jquery/jquery-3.6.0.min.js') }}"></script>--}}
<script src="{{ asset('helpers/libs/sweetalert2/sweetalert2.all.min.js') }}"></script>
<script src="{{ asset('helpers/libs/toast/jquery.toast.min.js') }}"></script>
